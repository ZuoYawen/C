...
insert  into `lend_list`(`ser_num`,`book_id`,`reader_id`,`lend_date`,`back_date`) values (1,1,10000,'2017-03-15','2017-06-16'),(2,2,10001,'2017-06-10','2017-09-02'),(3,3,10003,'2017-06-12','2017-09-02'),(4,4,10000,'2017-03-15','2017-09-03'),(5,5,10002,'2017-06-15',NULL),(6,6,10000,'2017-06-15',NULL),(7,1,10001,'2017-09-02','2017-09-02');
...
insert  into `reader_card`(`reader_id`,`username`,`password`) values (10000,'张华','123456'),(10001,'小红','123456'),(10002,'小花','123456'),(10003,'小明','123456'),(10004,'李明','123456'),(10005,'张飞','123456');
...
insert  into `reader_info`(`reader_id`,`name`,`sex`,`birth`,`address`,`phone`) values (10000,'小红','男','1995-06-10','天津市','12345678900'),(10001,'小花','男','1996-02-01','北京市','12345678909'),(10002,'小草','女','1995-04-15','浙江省杭州市','12345678908'),(10003,'小明','男','1996-08-29','陕西省西安市','12345678907'),(10004,'sust','男','1996-01-01','陕西省西安市','12345678910'),(10005,'Javaweb','男','1996-05-03','山东省青岛市','12345678901');
